...
Owner: coordinator
Current phase: contract and compatibility proof
...
Estimate: two to four days after a reviewable Cognee metadata patch exists.
...
Estimate: one to two days for the contract decision, excluding implementation.
...
Estimate: two to three days after the adapter passes.
...
Estimate: about half a day if Railway service provisioning is available.
