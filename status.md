...
Current phase: source and docs checkpoints pushed; draft PR 256 is blocked by DCO, GPL license policy, gitleaks, and local Docker capacity gates
...
## Blocked
- [ ] BLK-2026-08-10-06, owner: release, severity: High, next escalation: decide a precise history-safe allowlist or replace the example placeholder while preserving secret-scan coverage. Evidence: `agents/blockers.md`.
- [ ] BLK-2026-08-10-05, owner: architect, severity: Critical, next escalation: select a license-compatible graph runtime or record an approved distribution decision before release. Evidence: `agents/blockers.md`.
- [ ] BLK-2026-08-10-04, owner: release, severity: High, next escalation: obtain explicit approval to rewrite only the affected draft-PR commits with matching DCO trailers and force-push with lease. Evidence: `agents/blockers.md`.
- [ ] BLK-2026-08-10-03, owner: release, severity: High, next escalation: obtain explicit approval to remove only `3.817GB` of rebuildable BuildKit cache, verify protected Docker resources, then resume the corrected image gate. Evidence: `agents/blockers.md`.
